import svgPaths from "./svg-qeygfjt6u3";
...
function Title() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="title">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Sora:Bold',sans-serif] leading-[1.5] min-w-px not-italic relative text-[#191919] text-[24px]">Ingresa los datos</p>
    </div>
  );
}
...
function Title1() {
  return (
    <div className="content-stretch flex gap-[2px] items-start relative shrink-0" data-name="Title">
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[12px] text-center whitespace-nowrap">Número de cliente</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-w-px relative" data-name="Left">
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#191919] text-[14px] text-center whitespace-nowrap">
        ...
        <span className="leading-[1.5] text-[#bac2c7]">Entre 2 y 8 dígitos</span>
      </p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-start min-h-px relative w-full" data-name="content">
      ...
      <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[328px]" data-name="account">
        <Title1 />
        <Field />
        <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[12px] text-center whitespace-nowrap">El primer dígito no puede ser cero</p>
      </div>
    </div>
  );
}
...
export default function BuscarServicio() {
  return (
    <div className="bg-white relative size-full" data-name="BuscarServicio2">
