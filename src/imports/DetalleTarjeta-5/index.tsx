import svgPaths from "./svg-beqwaj9yjp";
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Icon">
      ...
      <div className="col-1 ml-[6px] mt-[6px] overflow-clip relative row-1 size-[20px]" data-name="Style=Outlined">
        <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[17.999px] left-[calc(50%-0.18px)] top-1/2 w-[17.64px]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.64 17.9991">
            <g id="Vector">
              <path d={svgPaths.p313b9d00} fill="var(--fill-0, #535D66)" />
              <path d={svgPaths.p1b3c9540} fill="var(--fill-0, #535D66)" />
              <path d={svgPaths.pefacf00} fill="var(--fill-0, #535D66)" />
              <path d={svgPaths.p29f2ee80} fill="var(--fill-0, #535D66)" />
            </g>
          </svg>
        </div>
      </div>
...
function Label() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[34px]" data-name="Label">
      <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] min-w-full not-italic relative shrink-0 text-[#191919] text-[12px] w-[min-content]">Agregar a Google Wallet</p>
    </div>
  );
}
