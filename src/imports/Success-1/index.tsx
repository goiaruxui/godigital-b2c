import svgPaths from "./svg-8a1aqegby6";
...
function Text() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[4px] items-center not-italic relative shrink-0 text-center w-full" data-name="Text">
      <div className="font-['Sora:Bold',sans-serif] leading-[0] relative shrink-0 text-[#191919] text-[16px] w-full">
        <p className="leading-[1.5] mb-0">¡Felicitaciones, terminaste</p>
        <p className="leading-[1.5]">la validación!</p>
      </div>
      <p className="font-['Sora:Regular',sans-serif] leading-[1.5] relative shrink-0 text-[#535d66] text-[14px] w-full">Gracias por verificar tu identidad.</p>
    </div>
  );
}
...
function Wait() {
  return (
    <div className="[word-break:break-word] content-stretch flex font-['Sora:Regular',sans-serif] gap-[3px] items-start justify-center leading-[1.5] not-italic relative shrink-0 text-[#78838d] text-[14px] w-full whitespace-nowrap" data-name="wait">
      <p className="relative shrink-0">Serás redirigido en</p>
      <p className="relative shrink-0">5</p>
      <p className="relative shrink-0">segundos...</p>
    </div>
  );
}
