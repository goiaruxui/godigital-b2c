import svgPaths from "./svg-1u8pg8ifna";
...
function Text() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[4px] items-center leading-[1.5] not-italic relative shrink-0 text-center w-full" data-name="Text">
      <p className="font-['Sora:Bold',sans-serif] relative shrink-0 text-[#191919] text-[16px] w-full">¡Transferencia exitosa!</p>
      <p className="font-['Sora:Regular',sans-serif] relative shrink-0 text-[#535d66] text-[14px] w-full">La transferencia se ha realizado correctamente.</p>
    </div>
  );
}
  ...
  return (
    <div className="relative rounded-[8px] shrink-0 w-full" data-name="itemlist">
      ...
      <div className="[word-break:break-word] content-stretch flex flex-col items-start leading-[1.5] not-italic px-[16px] py-[12px] relative size-full text-[12px]">
        <p className="font-['Sora:Regular',sans-serif] relative shrink-0 text-[#78838d] whitespace-nowrap">Contacto</p>
        <p className="font-['Sora:Bold',sans-serif] min-w-full relative shrink-0 text-[#535d66] w-[min-content]">Alan Frias</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative rounded-[8px] shrink-0 w-full" data-name="itemlist">
      ...
      <div className="[word-break:break-word] content-stretch flex flex-col items-start leading-[1.5] not-italic px-[16px] py-[12px] relative size-full text-[12px]">
        ...
        <p className="font-['Sora:Bold',sans-serif] min-w-full relative shrink-0 text-[#535d66] w-[min-content]">$10.000,00</p>
      </div>
    </div>
  );
}
...
function List() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center relative shrink-0 w-full" data-name="list">
      <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[14px] w-full">Detalle de la transferencia</p>
      <Itemlist />
      <Itemlist1 />
      <Itemlist2 />
...
function Body() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[48px] inset-[44px_0_0_0] items-center justify-end pb-[40px] pt-[16px] px-[16px]" data-name="body">
      <Content />
      <Buttons />
    </div>
  );
...
export default function TransferSuccess() {
  return (
    <div className="bg-white relative size-full" data-name="Transfer success">
