import svgPaths from "./svg-bqexwbu4ia";
  ...
  return (
    <div className="absolute bg-white bottom-0 content-stretch drop-shadow-[0px_8px_12px_rgba(0,0,0,0.2)] flex flex-col gap-[24px] h-[384px] items-center justify-end left-0 pb-[40px] pt-[16px] px-[16px] right-0 rounded-tl-[16px] rounded-tr-[16px]" data-name="BottomSheet">
      ...
      <div className="h-[45px] overflow-clip relative rounded-[4px] shrink-0 w-full" data-name="SlideButton">
        <div className="-translate-y-1/2 absolute bg-[#df4730] content-stretch flex gap-[4px] h-[45px] items-center justify-center left-[44px] p-[12px] right-0 rounded-[4px] top-1/2" data-name="button2">
          <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Label</p>
        </div>
        <div className="-translate-y-1/2 absolute bg-[#ff583f] content-stretch flex gap-[4px] h-[45px] items-center justify-end left-0 p-[12px] right-0 rounded-[4px] top-1/2" data-name="button1">
        ...
        <div className="overflow-clip relative shrink-0 size-[20px]" role="button" tabIndex="0" data-name="Style=Outlined">
          <div className="absolute bottom-1/4 left-[34.56%] right-[34.56%] top-1/4" data-name="Vector">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6.175 10">
              <path d={svgPaths.pfe69d00} fill="var(--fill-0, #BAC2C7)" id="Vector" />
            </svg>
          </div>
        </div>
        <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#bac2c7] text-[14px] text-center whitespace-nowrap">Volver</p>
      </a>
    </div>
  );
}
...
export default function PagoQrSelectCardProcessing() {
  return (
    <div className="relative size-full" data-name="PagoQR-SelectCard-Processing">
