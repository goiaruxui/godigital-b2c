import svgPaths from "./svg-189uv7mtqk";
...
function Amount() {
  return (
    <div className="bg-[#f7f8fe] content-stretch flex flex-col items-center justify-center px-[8px] py-[16px] relative rounded-[8px] shrink-0 w-[328px]" data-name="amount">
      <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#78838d] text-[21px] text-right whitespace-nowrap">-$7.846,62</p>
    </div>
  );
}
...
function Itemlist() {
  return (
    <div className="content-stretch flex flex-col items-start px-[16px] py-[12px] relative rounded-[8px] shrink-0 w-[328px]" data-name="itemlist">
      ...
      <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] min-w-full not-italic relative shrink-0 text-[#535d66] text-[12px] w-[min-content]">26 de marzo de 2024 - 15:21</p>
    </div>
  );
}
