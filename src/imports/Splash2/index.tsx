import svgPaths from "./svg-iohgywxy3q";
  ...
  return (
    <div className="absolute inset-[5%_6.5%_10%_7.89%]" data-name="Logo Gollet">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 37.6663 20.3999">
        <g id="Logo Gollet">
          <g id="Gonnectia">
            <path d={svgPaths.p39d6a500} fill="var(--fill-0, white)" id="Vector" />
            <path d={svgPaths.p19720a00} fill="var(--fill-0, white)" id="Vector_2" />
          </g>
          <path d={svgPaths.pe831600} fill="var(--fill-0, #FDC228)" id="Ellipse 20" />
          <path d={svgPaths.p3ad35c00} fill="var(--fill-0, #FDC228)" id="Ellipse 21" />
        </g>
      </svg>
    </div>
  );
...
function LogoGollet1() {
  return (
    <div className="absolute inset-[6.96%_3.28%_7.94%_4.92%]" data-name="Logo Gollet">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 205.64 62.4421">
        <g id="Logo Gollet">
          <g id="Gollet">
            <path d={svgPaths.p2e288800} fill="var(--fill-0, #FF6C3B)" />
            <path d={svgPaths.p31a05240} fill="var(--fill-0, #FF6C3B)" />
            <path d={svgPaths.p2ee9c680} fill="var(--fill-0, #FF6C3B)" />
            <path d={svgPaths.p3302f770} fill="var(--fill-0, #FF6C3B)" />
            <path d={svgPaths.p12071ca0} fill="var(--fill-0, #FF6C3B)" />
            <path d={svgPaths.p372af000} fill="var(--fill-0, #FF6C3B)" />
          </g>
          <path d={svgPaths.pe76e580} fill="var(--fill-0, #FDC228)" id="Ellipse 20" />
          <path d={svgPaths.p28344200} fill="var(--fill-0, #FDC228)" id="Ellipse 21" />
        </g>
      </svg>
    </div>
  );
...
export default function Splash() {
  return (
    <div className="relative size-full" data-name="Splash2">
      <InicipoApp />
      <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-white h-[800px] left-1/2 overflow-clip top-1/2 w-[360px]" data-name="Splash">
        <div className="absolute inset-[45.38%_18.89%_45.45%_18.89%]" data-name="Logo">
          <LogoGollet1 />
        </div>
