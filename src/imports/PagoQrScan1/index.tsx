import svgPaths from "./svg-f41je0s8lk";
import imgQrImage from "./8c11fdc709e1895f742e87b196904504c165f5e4.png";
...
export default function PagoQrScan() {
  return (
    <div className="relative size-full" data-name="PagoQR-Scan1">
