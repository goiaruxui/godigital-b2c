import svgPaths from "./svg-cpkjfbjcx4";
import { imgRectangle2 } from "./svg-f38p4";
...
function Title() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="title">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Sora:Bold',sans-serif] leading-[1.5] min-w-px not-italic relative text-[#191919] text-[24px]">Intercambiar</p>
    </div>
  );
}
...
function Input() {
  return (
    <div className="flex flex-[1_0_0] flex-row items-center self-stretch">
      <div className="content-stretch flex flex-[1_0_0] gap-[4px] h-full items-center min-w-px relative" data-name="input">
        <div className="h-full relative shrink-0 w-0" data-name="cursor">
          <div className="absolute inset-[0_-1px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2 37">
              <path d="M1 4.37114e-08L1 37" id="cursor" stroke="var(--stroke-0, #191919)" strokeWidth="2" />
            </svg>
          </div>
        </div>
        <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#bac2c7] text-[21px] text-center whitespace-nowrap">0</p>
      </div>
    </div>
  );
}
...
function Left() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Left">
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#ff583f] text-[14px] text-center whitespace-nowrap">ARS</p>
    </div>
  );
}
      ...
      <div className="overflow-clip relative shrink-0 size-[20px]" data-name="arrow-down-s-line">
        <div className="absolute inset-[34.26%_23.48%_33.33%_23.48%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.6067 6.48167">
            <path d={svgPaths.p2de05080} fill="var(--fill-0, #FF583F)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Money() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="money">
...
function Div() {
  return (
    <div className="content-stretch flex gap-[4px] items-center justify-end relative shrink-0 w-full" data-name="div">
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#78838d] text-[12px] whitespace-nowrap">Disponible: 22.440,00</p>
      <p className="[word-break:break-word] flex-[1_0_0] font-['Sora:Regular',sans-serif] leading-[1.5] min-w-px not-italic relative text-[#78838d] text-[12px]">ARS</p>
      <div className="content-stretch flex gap-[2px] items-center justify-center p-[4px] relative rounded-[4px] shrink-0" data-name="button">
        <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#df4730] text-[14px] text-center whitespace-nowrap">Usar todo</p>
      </div>
    </div>
  );
}
...
function Amount() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-end relative shrink-0 w-full" data-name="amount">
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#78838d] text-[12px] w-full">Quiero intercambiar</p>
      <Money />
      <div className="h-0 relative shrink-0 w-full" data-name="divider">
        <div className="absolute inset-[-1px_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 328 2">
            <path d="M0 1H328" id="divider" stroke="var(--stroke-0, #DF4730)" strokeWidth="2" />
          </svg>
        </div>
      </div>
      <Div />
...
function Left1() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Left">
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#ff583f] text-[14px] text-center whitespace-nowrap">USDT</p>
    </div>
  );
}
...
function Amount1() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-end relative shrink-0 w-full" data-name="amount">
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] min-w-full not-italic relative shrink-0 text-[#78838d] text-[12px] w-[min-content]">Quiero recibir</p>
      <Money1 />
      <div className="h-0 relative shrink-0 w-full" data-name="divider">
        <div className="absolute inset-[-1px_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 328 2">
            <path d="M0 1H328" id="divider" stroke="var(--stroke-0, #BAC2C7)" strokeWidth="2" />
          </svg>
        </div>
      </div>
    </div>
            ...
            <div className="overflow-clip relative shrink-0 size-[20px]" data-name="Style=Outlined">
              <div className="absolute inset-[8.33%]" data-name="Vector">
                <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.6667 16.6667">
                  <path d={svgPaths.p32862f80} fill="var(--fill-0, #DF4730)" id="Vector" />
                </svg>
              </div>
            </div>
          </div>
...
export default function Intercambiar() {
  return (
    <div className="relative size-full" data-name="Intercambiar">
      <div className="absolute bg-white h-[800px] left-0 overflow-clip top-0 w-[360px]" data-name="Intercambiar2">
