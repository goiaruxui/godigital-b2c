import svgPaths from "./svg-8v2kxq66jq";
...
function Bezel() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[157px] left-[calc(50%-1.21px)] overflow-clip rounded-[8px] top-[calc(50%-1.37px)] w-[155px]" data-name="Bezel">
      ...
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['SF_Pro:Light',sans-serif] font-[274.31500244140625] leading-[normal] left-[calc(50%+0.5px)] text-[72px] text-center text-white top-[calc(50%-60.5px)] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>{`\u{100062}`}</p>
    </div>
  );
}
...
export default function LoginFaceId() {
  return (
    <div className="bg-white relative size-full" data-name="Login-FaceID2">
