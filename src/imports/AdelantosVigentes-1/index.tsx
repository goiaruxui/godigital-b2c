import svgPaths from "./svg-h0ripqpju5";
    ...
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Typography">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[8px] py-[11px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Sora:Bold',sans-serif] leading-[1.5] min-w-px not-italic relative text-[#005794] text-[14px] text-center">Vigentes</p>
        </div>
      </div>
    </div>
  );
        ...
        <div className="h-0 relative shrink-0 w-full" data-name="Line">
          <div className="absolute inset-[-1px_-0.61%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 166 2">
              <path d="M1 1H165" id="Line" stroke="var(--stroke-0, #005794)" strokeLinecap="round" strokeWidth="2" />
            </svg>
          </div>
        </div>
      </div>
...
function Text() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="text">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Sora:Bold',sans-serif] leading-[1.5] min-w-px not-italic relative text-[#191919] text-[16px] text-left">$90.000.000</p>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-w-px relative">
      <Text />
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[12px] text-right whitespace-nowrap">Adelantado $40.000.000,00</p>
    </div>
  );
}
...
function Bar() {
  return <div className="bg-[#005794] flex-[1_0_0] min-h-px relative w-[90px]" data-name="bar" />;
}
...
function Progress() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Progress">
      <ProgressBar />
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[12px] text-right w-[94px]">3 cuotas</p>
    </div>
  );
}
...
function Div() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col items-start leading-[1.5] min-w-px not-italic relative text-left" data-name="div">
      <p className="font-['Sora:Regular',sans-serif] relative shrink-0 text-[#535d66] text-[12px] w-full">Ingreso</p>
...
function Div1() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col items-start leading-[1.5] min-w-px not-italic relative text-left" data-name="div">
      <p className="font-['Sora:Regular',sans-serif] relative shrink-0 text-[#535d66] text-[12px] whitespace-nowrap">Próximo vto.</p>
      <p className="font-['Sora:Bold',sans-serif] min-w-full relative shrink-0 text-[#191919] text-[14px] w-[min-content]">15/05/2026</p>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="text">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Sora:Bold',sans-serif] leading-[1.5] min-w-px not-italic relative text-[#191919] text-[16px]">$50.000.000</p>
    </div>
  );
}
...
function Progress1() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Progress">
      <ProgressBar1 />
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[12px] text-right w-[94px]">1 cuota</p>
    </div>
  );
}
