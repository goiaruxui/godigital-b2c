import svgPaths from "./svg-hkk7b5rmrl";
...
function Money() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="money">
      ...
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#bac2c7] text-[36px] text-center whitespace-nowrap">{` `}</p>
    </div>
  );
}
      ...
      <div className="bg-[#edeff6] h-[45px] relative rounded-[4px] shrink-0 w-full" data-name="button">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex gap-[4px] items-center justify-center p-[12px] relative size-full">
            <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#bac2c7] text-[14px] text-center whitespace-nowrap">Cambiar PIN</p>
          </div>
        </div>
      </div>
    </div>
...
export default function CambiarPinEmpty() {
  return (
    <div className="bg-white relative size-full" data-name="CambiarPIN-Empty">
      ...
      <Body />
      <div className="absolute backdrop-blur-[10px] bg-[rgba(204,206,211,0.76)] bottom-[-231px] content-stretch flex flex-col gap-[7px] h-[231px] items-start left-0 p-[6px] right-0" data-name="Component 1">
        <RowNumbers />
        <RowNumbers1 />
        <RowNumbers2 />
        <RowNumbers3 />
      </div>
      <div className="absolute bottom-[-56px] content-stretch flex flex-col items-start justify-center left-0 right-0" data-name="Navigation">
