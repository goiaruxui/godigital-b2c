import svgPaths from "./svg-ypwz2e7n24";
...
import imgDocument from "./e0bc47d0ae63ac8dca572e27f3c5e937b42218e0.png";
...
function Text() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] h-[120px] items-center leading-[1.5] not-italic relative shrink-0 w-full" data-name="text">
      <p className="font-['Sora:Bold',sans-serif] relative shrink-0 text-[#191919] text-[18px] w-full">Toma la foto del dorso de tu documento</p>
      <p className="font-['Sora:Regular',sans-serif] relative shrink-0 text-[#78838d] text-[14px] w-full">Centra el documento dentro del área segura para que podamos realizar la validación.</p>
    </div>
  );
}
...
function FotoDorsoDni() {
  return (
    <div className="absolute contents inset-[-102.04%_-43.31%_-116.76%_-28.24%]" data-name="Foto-DorsoDNI">
      <ImagenDocumento />
...
export default function GoIdentityDorsoDocumento() {
  return (
    <div className="bg-white relative size-full" data-name="GOIdentity-DorsoDocumento-1">
