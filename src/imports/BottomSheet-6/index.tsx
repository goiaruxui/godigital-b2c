import svgPaths from "./svg-86bc1tpr7g";

function Text() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col items-start leading-[1.5] min-w-px not-italic relative whitespace-nowrap" data-name="text">
      <p className="font-['Sora:Bold',sans-serif] relative shrink-0 text-[#191919] text-[16px]">Ingreso de dinero</p>
      <p className="font-['Sora:Regular',sans-serif] relative shrink-0 text-[#78838d] text-[14px]">Desde una cuenta propia</p>
    </div>
  );
}
...
function Movement() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[12px] items-center min-w-px relative" data-name="movement">
...
function Amount() {
  return (
    <div className="bg-[#f4fff8] content-stretch flex flex-col items-center justify-center px-[8px] py-[16px] relative rounded-[8px] shrink-0 w-[328px]" data-name="amount">
      <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#289b4f] text-[21px] text-right whitespace-nowrap">+$25.000,00</p>
    </div>
  );
}
...
function Itemlist() {
  return (
    <div className="content-stretch flex flex-col items-start px-[16px] py-[12px] relative rounded-[8px] shrink-0 w-[328px]" data-name="itemlist">
      ...
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#78838d] text-[12px] whitespace-nowrap">Ayer</p>
      <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] min-w-full not-italic relative shrink-0 text-[#535d66] text-[12px] w-[min-content]">{`25 de marzo de 2024 - 12:32 `}</p>
    </div>
  );
}
...
function TransactionDetails() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0" data-name="Transaction details">
      <Amount />
      <Itemlist />
      <Itemlist1 />
    </div>
