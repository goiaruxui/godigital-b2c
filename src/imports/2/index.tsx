import svgPaths from "./svg-1jg99rac3o";
import imgCapturaDePantalla20231024ALaS11034 from "./ae55f40a0ddb4672b376b06b78e7b59271dea25e.png";

function Frame2() {
  return (
    <div className="bg-[#f7f8fe] content-stretch flex items-center justify-center px-[16px] py-[8px] relative rounded-[8px] shrink-0">
      <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[18px] text-center whitespace-nowrap">Mira hacia adelante</p>
    </div>
  );
}
...
function Camera() {
  return (
    <div className="h-[343px] overflow-clip relative rounded-[8px] shrink-0 w-full" data-name="camera">
      <div className="absolute inset-[0.15%_-49.04%_-0.44%_-45.83%] rounded-[8px]" data-name="Captura de pantalla 2023-10-24 a la(s) 11.03 4">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[8px]">
          <img alt="" className="absolute h-[170.91%] left-[-7.99%] max-w-none top-[-6.67%] w-[113.17%]" src={imgCapturaDePantalla20231024ALaS11034} />
        </div>
      </div>
