import svgPaths from "./svg-y16mc0gl5r";
...
function Text() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="text">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Sora:Bold',sans-serif] leading-[1.5] min-w-px not-italic relative text-[#191919] text-[16px]">$90.000.000</p>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-w-px relative">
      <Text />
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[12px] text-right whitespace-nowrap">Adelantado $50.000.000,00</p>
    </div>
  );
}
...
function Bar() {
  return <div className="bg-[#005794] flex-[1_0_0] min-h-px relative w-[138px]" data-name="bar" />;
}
