import svgPaths from "./svg-53lu6dqhnu";
...
function Left() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-w-px relative" data-name="Left">
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#bac2c7] text-[14px] text-center whitespace-nowrap">|</p>
    </div>
  );
}
...
export default function LoginFaceId() {
  return (
    <div className="bg-white relative size-full" data-name="Login-FaceID1">
      ...
      <Body />
      <div className="absolute bg-[rgba(0,0,0,0.2)] inset-0" data-name="Face ID">
        <Bezel />
      </div>
