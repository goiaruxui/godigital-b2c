import svgPaths from "./svg-kvvl7p1bba";
...
function Title() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="title">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Sora:Bold',sans-serif] leading-[1.5] min-w-px not-italic relative text-[#191919] text-[24px]">Agregar a Google Wallet</p>
    </div>
  );
}
...
function Name() {
  return (
    <div className="content-stretch flex gap-[12px] items-start relative shrink-0" data-name="Name">
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#fff2f0] text-[12px] whitespace-nowrap">LAURA MARTINEZ</p>
    </div>
  );
}
...
function Div() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[8px] items-center leading-[1.5] not-italic relative shrink-0 text-center w-full" data-name="div">
      <p className="font-['Sora:Bold',sans-serif] relative shrink-0 text-[#191919] text-[18px] w-full">Simplifica tus pagos con Google</p>
      <p className="font-['Sora:Regular',sans-serif] relative shrink-0 text-[#535d66] text-[14px] w-full">Agrega tu tarjeta a Google Wallet y paga con un simple toque en tiendas, aplicaciones y mucho más.</p>
    </div>
  );
}
...
function Content() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-center min-h-px relative w-full" data-name="content">
      <div className="content-stretch drop-shadow-[0px_0px_8px_rgba(0,0,0,0.15)] flex h-[210px] items-center justify-end relative shrink-0 w-full" data-name="Cards">
        <Card />
      </div>
      <Div />
      <div className="h-[46px] overflow-clip relative shrink-0 w-[153px]" data-name="Wallets - Buttons">
        <div className="absolute inset-[0.91%_0.25%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 152.231 45.1636">
            <path d={svgPaths.p68c8dc0} fill="var(--fill-0, #1F1F1F)" id="Vector" />
          </svg>
        </div>
        <div className="absolute inset-[22.73%_71.36%_56.74%_10.55%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 27.6784 9.4433">
            <path d={svgPaths.p24542e00} fill="var(--fill-0, #34A853)" id="Vector" />
          </svg>
        </div>
        <div className="absolute inset-[30.91%_71.36%_47.27%_10.55%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 27.6784 10.0364">
            <path d={svgPaths.pfea4b00} fill="var(--fill-0, #FBBC04)" id="Vector" />
          </svg>
        </div>
        <div className="absolute inset-[40%_71.36%_38.18%_10.55%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 27.6784 10.0364">
            <path d={svgPaths.pfea4b00} fill="var(--fill-0, #EA4335)" id="Vector" />
          </svg>
        </div>
        <div className="absolute inset-[45.31%_71.36%_22.73%_10.55%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 27.6784 14.7046">
            <path d={svgPaths.p21190840} fill="url(#paint0_linear_27_4444)" id="Vector" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_27_4444" x1="12.5201" x2="-3.1058" y1="7.63307" y2="24.4632">
        ...
        <div className="absolute inset-[21.53%_40.48%_60.53%_34.77%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 37.8656 8.2524">
            <path d={svgPaths.p288247f0} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
        <div className="absolute inset-[52.83%_10.1%_17.38%_35.06%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 83.9032 13.7063">
            <path d={svgPaths.p1bd8c900} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
        <div className="absolute inset-[0.91%_0.25%]" data-name="Vector">
          <div className="absolute inset-[-1.11%_-0.33%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 153.231 46.1636">
              <path d={svgPaths.p25870df0} id="Vector" stroke="var(--stroke-0, #747775)" />
            </svg>
          </div>
        </div>
      </div>
...
function Body() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] inset-[44px_0_0_0] items-center pb-[40px] pt-[16px] px-[16px]" data-name="body">
      ...
      <Content />
      <div className="content-stretch flex gap-[2px] items-center justify-center p-[4px] relative rounded-[4px] shrink-0 w-[328px]" data-name="button">
        <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#df4730] text-[14px] text-center whitespace-nowrap">Más información sobre Google Pay</p>
      </div>
    </div>
  );
}
...
export default function TarjetaGoogleWallet() {
  return (
    <div className="relative size-full" data-name="Tarjeta-GoogleWallet">
