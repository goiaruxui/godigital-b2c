import svgPaths from "./svg-7ub7wmvpkw";
...
function Title() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="title">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Sora:Bold',sans-serif] leading-[1.5] min-w-px not-italic relative text-[#191919] text-[24px]">Préstamo personal</p>
    </div>
  );
}
...
function Text() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col items-start leading-[1.5] not-italic relative shrink-0 text-[#535d66] text-center w-full" data-name="text">
      <p className="font-['Sora:Bold',sans-serif] relative shrink-0 text-[16px] w-full">¡Tienes hasta $2.500.000!</p>
      <p className="font-['Sora:Regular',sans-serif] relative shrink-0 text-[14px] w-full">Puedes devolverlo hasta en 12 cuotas fijas.</p>
    </div>
  );
}
...
function Il() {
  return (
    <div className="relative rounded-[8px] shrink-0 w-full" data-name="il">
...
function Text1() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col items-start leading-[1.5] not-italic relative shrink-0 text-[#535d66] text-center w-full" data-name="text">
      <p className="font-['Sora:Bold',sans-serif] relative shrink-0 text-[16px] w-full">¡Recibelo al instante!</p>
      <p className="font-['Sora:Regular',sans-serif] relative shrink-0 text-[14px] w-full">Obten tu préstamo de manera fácil y sencilla en el momento.</p>
    </div>
  );
}
    ...
    <div className="relative rounded-[8px] shrink-0 w-full" data-name="il">
      ...
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-center justify-center p-[12px] relative size-full">
          <div className="bg-[#fff2f0] content-stretch flex items-center justify-center overflow-clip p-[6px] relative rounded-[64px] shrink-0" data-name="IconItem">
            <div className="overflow-clip relative shrink-0 size-[20px]" data-name="Style=Outlined">
              <div className="absolute inset-[8.33%_29.17%]" data-name="Vector">
                <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.33333 16.6667">
                  <path d={svgPaths.p11f4b200} fill="var(--fill-0, #FF583F)" id="Vector" />
                </svg>
              </div>
            </div>
          </div>
...
function Title1() {
  return (
    <div className="content-stretch flex font-['Sora:Bold',sans-serif] gap-[4px] items-start justify-center relative shrink-0 text-[16px] w-full whitespace-nowrap" data-name="title">
      <p className="relative shrink-0">En tu cuenta de</p>
...
function Text2() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col items-start leading-[1.5] not-italic relative shrink-0 text-[#535d66] text-center w-full" data-name="text">
      <Title1 />
      <p className="font-['Sora:Regular',sans-serif] relative shrink-0 text-[14px] w-full">Una vez que tengas el dinero, tú eliges como usarlo.</p>
    </div>
  );
}
            ...
            <div className="overflow-clip relative shrink-0 size-[20px]" data-name="Style=Outlined">
              <div className="absolute inset-[12.5%_10.42%]" data-name="Vector">
                <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.8333 15">
                  <g id="Vector">
                    <path d={svgPaths.p23c30d30} fill="var(--fill-0, #FF583F)" />
                    <path d={svgPaths.p20686540} fill="var(--fill-0, #FF583F)" />
                  </g>
                </svg>
              </div>
            </div>
...
function Ul() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-center relative shrink-0 w-full" data-name="ul">
      <Il />
      <Il1 />
      <Il2 />
    </div>
      ...
      <div className="bg-[#df4730] h-[45px] relative rounded-[4px] shrink-0 w-full" data-name="button">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex gap-[4px] items-center justify-center p-[12px] relative size-full">
            <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Simular</p>
          </div>
        </div>
      </div>
    </div>
...
export default function Prestamos() {
  return (
    <div className="relative size-full" data-name="Préstamos">
