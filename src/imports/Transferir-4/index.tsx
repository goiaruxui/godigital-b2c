import svgPaths from "./svg-2h4sgls27h";
...
function Buttons() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="buttons">
      <div className="h-[45px] overflow-clip relative rounded-[4px] shrink-0 w-[328px]" data-name="SlideButton">
