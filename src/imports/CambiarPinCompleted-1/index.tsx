import svgPaths from "./svg-nmk3oqigys";
...
function Title() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="title">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Sora:Bold',sans-serif] leading-[1.5] min-w-px not-italic relative text-[#191919] text-[24px]">Cambiar PIN</p>
    </div>
  );
}
...
function Text() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-w-px relative" data-name="text">
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#78838d] text-[14px] text-center w-full">Configura el PIN para extraer dinero en el cajero automático.</p>
    </div>
  );
}
...
function Receiver() {
  return (
    <div className="content-stretch flex items-center relative rounded-[8px] shrink-0 w-full" data-name="receiver">
      <Text />
    </div>
  );
}
...
function Money() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="money">
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[36px] text-center whitespace-nowrap">4270</p>
    </div>
  );
}
      ...
      <div className="h-0 relative shrink-0 w-full" data-name="divider">
        <div className="absolute inset-[-1px_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 197 2">
            <path d="M0 1H197" id="divider" stroke="var(--stroke-0, #BAC2C7)" strokeWidth="2" />
          </svg>
        </div>
      </div>
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#78838d] text-[12px] text-center whitespace-nowrap">Ingresar código de 4 dígitos</p>
    </div>
  );
}
...
function Loading1() {
  return (
    <div className="absolute contents inset-0" data-name="loading">
      <div className="absolute bg-[#fff2f0] bottom-3/4 left-[45.83%] right-[45.83%] rounded-[10px] top-0" />
      <div className="absolute bottom-[45.83%] flex items-center justify-center left-0 right-3/4 top-[45.83%]" style={{ containerType: "size" }}>
        <div className="-rotate-90 flex-none h-[100cqw] w-[100cqh]">
          <div className="bg-[#fff2f0] opacity-70 relative rounded-[10px] size-full" />
        </div>
      </div>
      <div className="absolute bottom-0 flex items-center justify-center left-[45.83%] right-[45.83%] top-3/4" style={{ containerType: "size" }}>
        <div className="flex-none h-[100cqh] rotate-180 w-[100cqw]">
          <div className="bg-[#fff2f0] opacity-50 relative rounded-[10px] size-full" />
        </div>
      </div>
      <div className="absolute bottom-[45.83%] flex items-center justify-center left-3/4 right-0 top-[45.83%]" style={{ containerType: "size" }}>
        <div className="flex-none h-[100cqw] rotate-90 w-[100cqh]">
          <div className="bg-[#fff2f0] opacity-30 relative rounded-[10px] size-full" />
        </div>
      </div>
      <div className="absolute flex inset-[11.7%_64.73%_64.73%_11.7%] items-center justify-center" style={{ containerType: "size" }}>
        <div className="-rotate-45 flex-none h-[hypot(75cqw,75cqh)] w-[hypot(25cqw,-25cqh)]">
          <div className="bg-[#fff2f0] opacity-80 relative rounded-[10px] size-full" />
        </div>
      </div>
      <div className="absolute flex inset-[64.73%_64.73%_11.7%_11.7%] items-center justify-center" style={{ containerType: "size" }}>
        <div className="-rotate-135 flex-none h-[hypot(75cqw,-75cqh)] w-[hypot(-25cqw,-25cqh)]">
          <div className="bg-[#fff2f0] opacity-60 relative rounded-[10px] size-full" />
        </div>
      </div>
      <div className="absolute flex inset-[64.73%_11.7%_11.7%_64.73%] items-center justify-center" style={{ containerType: "size" }}>
        <div className="flex-none h-[hypot(-75cqw,-75cqh)] rotate-135 w-[hypot(-25cqw,25cqh)]">
          <div className="bg-[#fff2f0] opacity-40 relative rounded-[10px] size-full" />
        </div>
      </div>
      <div className="absolute flex inset-[11.7%_11.7%_64.73%_64.73%] items-center justify-center" style={{ containerType: "size" }}>
        <div className="flex-none h-[hypot(-75cqw,75cqh)] rotate-45 w-[hypot(25cqw,25cqh)]">
          <div className="bg-[#fff2f0] opacity-10 relative rounded-[10px] size-full" />
        </div>
      </div>
    </div>
  );
...
function Buttons() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="buttons">
      <div className="bg-[#841a0a] h-[45px] relative rounded-[4px] shrink-0 w-full" data-name="button">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex gap-[4px] items-center justify-center p-[12px] relative size-full">
            <div className="relative shrink-0 size-[24px]" data-name="Loading">
              <Loading1 />
            </div>
          </div>
        </div>
...
export default function CambiarPinCompleted() {
  return (
    <div className="bg-white relative size-full" data-name="CambiarPIN-Completed">
