import svgPaths from "./svg-zo2xpyqhr0";
import imgVector76 from "./939ef9a37d4d90f77952e038ea32450158ca6fa7.png";
import imgWallmart from "./2b84fd745a18a7c8b84fae276dc66ef547f20980.png";
  ...
  return (
    <div className="absolute inset-[6.96%_3.28%_7.94%_4.92%]" data-name="Logo Gollet">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 67.2004 20.4228">
        <g id="Logo Gollet">
          <g id="Gollet">
            <path d={svgPaths.p3471bf00} fill="var(--fill-0, white)" />
            <path d={svgPaths.p21601f70} fill="var(--fill-0, white)" />
            <path d={svgPaths.p4c23200} fill="var(--fill-0, white)" />
            <path d={svgPaths.p2b385480} fill="var(--fill-0, white)" />
            <path d={svgPaths.p3e631000} fill="var(--fill-0, white)" />
            <path d={svgPaths.p325d7080} fill="var(--fill-0, white)" />
          </g>
...
function RightContent() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-end min-w-px relative" data-name="right-content">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Sora:Regular',sans-serif] leading-[1.5] min-w-px not-italic relative text-[12px] text-right text-white">Dinero en cuenta</p>
    </div>
  );
}
...
function Top() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0 w-full" data-name="Top">
      <div className="h-[24px] relative shrink-0 w-[73.2px]" data-name="Logo">
        <LogoGollet />
      </div>
      <RightContent />
    </div>
...
function Importe() {
  return (
    <div className="content-stretch flex items-center leading-[1.5] relative self-stretch shrink-0" data-name="Importe">
      <p className="font-['Sora:Bold',sans-serif] relative shrink-0 text-[21px] whitespace-nowrap">25.000</p>
      <p className="font-['Sora:Regular',sans-serif] h-[25px] relative shrink-0 text-[12px] w-[21px]">00</p>
    </div>
  );
}
...
function Price() {
  return (
    <div className="content-stretch flex gap-[4px] h-[32px] items-start relative shrink-0 text-center text-white w-full" data-name="price">
      <div className="flex flex-col font-['Sora:Regular',sans-serif] justify-center leading-[0] relative self-stretch shrink-0 text-[14px] w-[10px]">
...
function Balance() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col items-start not-italic relative shrink-0 w-[117px]" data-name="Balance">
      <p className="font-['Sora:Regular',sans-serif] leading-[1.5] mb-[-6px] opacity-80 relative shrink-0 text-[#f7f8fe] text-[12px] whitespace-nowrap">Disponible</p>
      <Price />
    </div>
  );
}
    ...
    <div className="bg-[#841a0a] flex-[1_0_0] h-full min-w-px relative rounded-[12px]" data-name="Card 2">
      <div className="flex flex-col items-end justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-end justify-between p-[20px] relative size-full">
          <Top />
          <div className="absolute left-[-39px] size-[192px] top-[-113px]">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 192 192">
              <circle cx="96" cy="96" id="Ellipse 12" opacity="0.5" r="95.5" stroke="var(--stroke-0, #DF4730)" />
            </svg>
          </div>
          <div className="absolute bottom-[-24px] right-[-61px] size-[162px]">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 162 162">
              <circle cx="81" cy="81" id="Ellipse 11" opacity="0.5" r="80.5" stroke="var(--stroke-0, #DF4730)" />
            </svg>
          </div>
          <Middle />
        </div>
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[18px]" data-name="nfc">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 24">
        <g id="nfc">
          <path clipRule="evenodd" d={svgPaths.p229aa80} fill="var(--fill-0, #F7F8FE)" fillRule="evenodd" id="Vector (Stroke)" />
        </g>
      </svg>
    </div>
  );
...
function RightContent1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center justify-end min-w-px relative" data-name="right-content">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Sora:Regular',sans-serif] leading-[1.5] min-w-px not-italic relative text-[12px] text-right text-white">PREPAGA</p>
      <Nfc />
    </div>
  );
}
...
function Importe1() {
  return (
    <div className="content-stretch flex items-center leading-[1.5] relative self-stretch shrink-0" data-name="Importe">
      <p className="font-['Sora:Bold',sans-serif] relative shrink-0 text-[21px] whitespace-nowrap">12.440</p>
      <p className="font-['Sora:Regular',sans-serif] h-[25px] relative shrink-0 text-[12px] w-[21px]">00</p>
    </div>
  );
}
...
function Number() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Number">
      <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">**** 2451</p>
    </div>
  );
}
...
function Bottom() {
  return (
    <div className="content-stretch flex h-[40px] items-end justify-between relative shrink-0 w-full" data-name="Bottom">
      <Info />
      <div className="h-[20.706px] relative shrink-0 w-[64px]" data-name="card-brands">
        <div className="absolute inset-[1.75%_51.6%_1.44%_35.23%]" data-name="polygon9">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.42689 20.0438">
            <path d={svgPaths.p2a4b97a0} fill="var(--fill-0, white)" id="polygon9" />
          </svg>
        </div>
        <div className="absolute inset-[0_27.3%_0_48.4%]" data-name="path11">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.5519 20.7059">
            <path d={svgPaths.p273c6d00} fill="var(--fill-0, white)" id="path11" />
          </svg>
        </div>
        <div className="absolute inset-[1.75%_0_1.44%_70.93%]" data-name="path13">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18.6033 20.0436">
            <path d={svgPaths.pf77aa00} fill="var(--fill-0, white)" id="path13" />
          </svg>
        </div>
        <div className="absolute inset-[1.75%_62.97%_1.55%_8.47%]" data-name="path15">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18.2821 20.0226">
            <path d={svgPaths.p3c39cb00} fill="var(--fill-0, white)" id="path15" />
          </svg>
        </div>
        <div className="absolute inset-[1.75%_80.33%_45.62%_0]" data-name="path17">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.5865 10.8968">
            <path d={svgPaths.p1c6402c0} fill="var(--fill-0, white)" id="path17" />
          </svg>
        </div>
      </div>
    </div>
      ...
      <div className="flex flex-col items-end justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-end justify-between p-[20px] relative size-full">
          ...
          <div className="absolute bottom-[-88px] right-0 size-[192px]">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 192 192">
              <circle cx="96" cy="96" fill="var(--fill-0, #FF583F)" id="Ellipse 10" opacity="0.5" r="96" />
            </svg>
          </div>
          <div className="absolute bottom-[-24px] right-[-61px] size-[162px]">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 162 162">
              <circle cx="81" cy="81" id="Ellipse 11" r="80.5" stroke="var(--stroke-0, #FFE7E3)" />
            </svg>
          </div>
          <Middle1 />
          <Bottom />
      ...
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start justify-between p-[20px] relative size-full">
          <div className="absolute bottom-[-2px] right-[-3px] top-[-9px] w-[117px]">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="191" src={imgVector76} width="117" />
          </div>
          <Info1 />
          <Bottom1 />
        </div>
  ...
  return (
    <div className="bg-[#f7f8fe] flex-[1_0_0] h-full min-w-px relative rounded-[12px]" data-name="Card 1">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[4px] items-center justify-center p-[20px] relative size-full">
          <div className="overflow-clip relative shrink-0 size-[24px]" data-name="add_circle_outline">
            <div className="absolute inset-[8.33%]" data-name="Vector">
              <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
                <path d={svgPaths.p10425500} fill="var(--fill-0, #78838D)" id="Vector" />
              </svg>
            </div>
          </div>
          <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] min-w-full not-italic relative shrink-0 text-[#78838d] text-[12px] text-center w-[min-content]">Agregar nueva tarjeta</p>
        </div>
      </div>
      <div aria-hidden className="absolute border border-[#e1e3ed] border-dashed inset-0 pointer-events-none rounded-[12px]" />
    </div>
  );
}
...
function Cards() {
  return (
    <div className="relative shrink-0 w-full" data-name="cards">
      <div className="content-stretch flex gap-[16px] items-start px-[12px] relative size-full">
        <div className="content-stretch drop-shadow-[0px_0px_8px_rgba(0,0,0,0.15)] flex h-[180px] items-center justify-end relative shrink-0 w-[303px]" data-name="Cards">
          <Card1 />
        </div>
        <div className="content-stretch drop-shadow-[0px_0px_8px_rgba(0,0,0,0.15)] flex h-[180px] items-center justify-end relative shrink-0 w-[303px]" data-name="Cards">
          <Card />
        </div>
        <div className="content-stretch drop-shadow-[0px_0px_8px_rgba(0,0,0,0.15)] flex h-[180px] items-start relative shrink-0 w-[303px]" data-name="Cards">
          <Card2 />
        </div>
        <div className="content-stretch flex h-[180px] items-center justify-end relative shrink-0 w-[303px]" data-name="Cards">
          <Card3 />
        </div>
      </div>
    </div>
...
function Pagination() {
  return (
    <div className="h-[10px] relative shrink-0 w-[50px]" data-name="pagination">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 50 10">
        <g id="pagination">
          <circle cx="5" cy="5" fill="var(--fill-0, #FF583F)" id="dot" r="5" />
          <circle cx="26" cy="5" fill="var(--fill-0, #EDEFF7)" id="dot_2" r="4" />
          <circle cx="46" cy="5" fill="var(--fill-0, #EDEFF7)" id="dot_3" r="4" />
        </g>
      </svg>
    </div>
  );
...
function Content() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-center min-h-px relative w-full" data-name="content">
      <div className="[word-break:break-word] flex flex-col font-['Sora:Bold',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#191919] text-[14px] w-[min-content]">
...
function BottomSheet() {
  return (
    <div className="absolute bg-white bottom-0 content-stretch drop-shadow-[0px_8px_12px_rgba(0,0,0,0.2)] flex flex-col gap-[24px] h-[384px] items-center justify-end left-0 pb-[40px] pt-[16px] px-[16px] right-0 rounded-tl-[16px] rounded-tr-[16px]" data-name="BottomSheet">
      <Content />
...
function Title() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="title">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Sora:Bold',sans-serif] leading-[1.5] min-w-px not-italic relative text-[#191919] text-[24px]">Pagar servicio</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[56px]" data-name="icon">
      <div className="absolute inset-0 pointer-events-none rounded-[100px]" data-name="Wallmart">
        ...
        <div aria-hidden className="absolute border border-[#f7f8fe] border-solid inset-[-0.5px] rounded-[100.5px]" />
      </div>
    </div>
  );
}
...
function Text() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col items-start justify-center leading-[1.5] not-italic relative shrink-0 text-center whitespace-nowrap" data-name="text">
      <p className="font-['Sora:Bold',sans-serif] relative shrink-0 text-[#191919] text-[16px]">Claro</p>
      <p className="font-['Sora:Regular',sans-serif] relative shrink-0 text-[#78838d] text-[14px]">Telefonía</p>
    </div>
  );
}
...
function Store() {
  return (
    <div className="content-stretch flex gap-[12px] items-center justify-center relative rounded-[8px] shrink-0 w-full" data-name="store">
      <Icon />
      <Text />
    </div>
  );
...
function Amount() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col font-['Sora:Regular',sans-serif] gap-[8px] items-center leading-[1.5] not-italic relative shrink-0 text-center w-full whitespace-nowrap" data-name="amount">
      <p className="relative shrink-0 text-[#78838d] text-[12px]">Pagar importe</p>
      <Money />
    </div>
  );
}
...
function Body() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] h-[372px] items-center left-0 pb-[40px] pt-[16px] px-[16px] right-0 top-[44px]" data-name="body">
...
export default function PagoServicioSelectCard() {
  return (
    <div className="relative size-full" data-name="PagoServicio-SelectCard">
