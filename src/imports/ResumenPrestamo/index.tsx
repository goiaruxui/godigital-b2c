import svgPaths from "./svg-towc6xuqhm";
...
function Title() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="title">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Sora:Bold',sans-serif] leading-[1.5] min-w-px not-italic relative text-[#191919] text-[24px]">Resumen del préstamo</p>
    </div>
  );
}
...
function Price() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0 text-[18px] whitespace-nowrap" data-name="Price">
      ...
      <p className="font-['Sora:Bold',sans-serif] relative shrink-0">10.000</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full" data-name="div">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="[word-break:break-word] content-stretch flex gap-[2px] items-center leading-[1.5] not-italic px-[8px] py-[12px] relative size-full text-[#191919]">
          <p className="flex-[1_0_0] font-['Sora:Regular',sans-serif] min-w-px relative text-[16px]">Recibes</p>
          <Price />
        </div>
      </div>
    </div>
...
function Price1() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0 text-[18px]" data-name="Price">
      <p className="font-['Sora:Regular',sans-serif] relative shrink-0">9x de $</p>
      <p className="font-['Sora:Bold',sans-serif] relative shrink-0">1.942,51</p>
    </div>
  );
}
...
function Column() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col items-end leading-[1.5] not-italic relative shrink-0 text-[#191919] whitespace-nowrap" data-name="Column">
      <Price1 />
      <p className="font-['Sora:Regular',sans-serif] relative shrink-0 text-[12px]">cuotas fijas</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="div">
      ...
      <div className="content-stretch flex gap-[2px] items-start px-[8px] py-[12px] relative size-full">
        <p className="[word-break:break-word] flex-[1_0_0] font-['Sora:Regular',sans-serif] leading-[1.5] min-w-px not-italic relative text-[#191919] text-[16px]">Pagas</p>
        <Row />
      </div>
    </div>
  );
...
function Row1() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0 w-full" data-name="row">
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#df4730] text-[12px] whitespace-nowrap">Modificar la fecha</p>
    </div>
  );
}
...
function Div3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[2px] items-start justify-center min-w-px relative" data-name="Div">
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[16px] w-full">Pagas la primer cuota</p>
      <Row1 />
    </div>
  );
}
...
function Price2() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Price">
      <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[18px] whitespace-nowrap">26 de abril</p>
    </div>
  );
}
...
function Price3() {
  return (
    <div className="[word-break:break-word] content-stretch flex gap-[2px] items-center leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[18px] whitespace-nowrap" data-name="Price">
      <p className="font-['Sora:Regular',sans-serif] relative shrink-0">$</p>
      <p className="font-['Sora:Bold',sans-serif] relative shrink-0">17.482,51</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full" data-name="div">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[2px] items-center px-[8px] py-[12px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Sora:Regular',sans-serif] leading-[1.5] min-w-px not-italic relative text-[#191919] text-[16px]">En total devuelves</p>
          <Row2 />
        </div>
      </div>
    </div>
...
function Il() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-full" data-name="il">
      <p className="relative shrink-0 text-[#78838d]">Tasa Nominal Anual (TNA)</p>
      <p className="relative shrink-0 text-[#535d66]">123,00%</p>
    </div>
  );
}
...
function Il1() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-full" data-name="il">
      <p className="relative shrink-0 text-[#78838d]">Tasa Efectiva Anual (TEA)</p>
      <p className="relative shrink-0 text-[#535d66]">222,51%</p>
    </div>
  );
}
...
function Il2() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-full" data-name="il">
      <p className="relative shrink-0 text-[#78838d]">Costo Financiero Total (CFT)</p>
      <p className="relative shrink-0 text-[#535d66]">306,74%</p>
    </div>
  );
}
      ...
      <a className="bg-[#df4730] cursor-pointer h-[45px] relative rounded-[4px] shrink-0 w-full" data-name="button">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex gap-[4px] items-center justify-center p-[12px] relative size-full">
            <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Solicitar préstamo</p>
          </div>
        </div>
      </a>
    </div>
  ...
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] inset-[44px_0_0_0] items-center pb-[40px] pt-[16px] px-[16px]" data-name="body">
      ...
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#535d66] text-[0px] text-center w-full">
        ...
        <span className="leading-[1.5] text-[#df4730] text-[14px]">términos generales</span>
        <span className="leading-[1.5] text-[14px]">{` y las `}</span>
        <span className="leading-[1.5] text-[#df4730] text-[14px]">condiciones específicas</span>
