import svgPaths from "./svg-666kgnxrqz";
...
function Text() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[4px] items-center leading-[1.5] not-italic relative shrink-0 text-center w-full" data-name="Text">
      <p className="font-['Sora:Bold',sans-serif] relative shrink-0 text-[#191919] text-[16px] w-full">¡Intercambio exitoso!</p>
      <p className="font-['Sora:Regular',sans-serif] relative shrink-0 text-[#535d66] text-[14px] w-full">El intercambio de monedas se ha realizado correctamente.</p>
    </div>
  );
}
  ...
  return (
    <div className="relative rounded-[8px] shrink-0 w-full" data-name="itemlist">
      ...
      <div className="[word-break:break-word] content-stretch flex flex-col items-start leading-[1.5] not-italic px-[16px] py-[12px] relative size-full text-[12px]">
        <p className="font-['Sora:Regular',sans-serif] relative shrink-0 text-[#78838d] whitespace-nowrap">Recibiste</p>
        <p className="font-['Sora:Bold',sans-serif] min-w-full relative shrink-0 text-[#535d66] w-[min-content]">9,082569 USDT</p>
      </div>
    </div>
  );
}
...
function Itemlist1() {
  return (
    <div className="relative rounded-[8px] shrink-0 w-full" data-name="itemlist">
      <div aria-hidden className="absolute border border-[#edeff6] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="[word-break:break-word] content-stretch flex flex-col items-start leading-[1.5] not-italic px-[16px] py-[12px] relative size-full text-[12px]">
        <p className="font-['Sora:Regular',sans-serif] relative shrink-0 text-[#78838d] whitespace-nowrap">Tasa de cambio</p>
        <p className="font-['Sora:Bold',sans-serif] min-w-full relative shrink-0 text-[#535d66] w-[min-content]">1 USDT = 998,45 ARS</p>
      </div>
    </div>
  );
}
...
function List() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center justify-center relative shrink-0 w-full" data-name="list">
      <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[14px] w-full">Detalle del intercambio</p>
      <Itemlist />
      <Itemlist1 />
      <Itemlist2 />
...
export default function IntercambioSuccess() {
  return (
    <div className="relative size-full" data-name="Intercambio-Success">
      <div className="absolute bg-white h-[800px] left-0 overflow-clip top-0 w-[360px]" data-name="PagoQR-Success">
