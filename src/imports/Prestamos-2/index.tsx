import svgPaths from "./svg-cmpwuzrmkt";
...
function Progress() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Progress">
      <ProgressBar />
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[12px] text-right w-[86px]">Cuota 3 de 3</p>
    </div>
  );
}
...
function Row() {
  return (
    <div className="content-stretch flex gap-[4px] items-start relative self-stretch shrink-0 w-[312px]" data-name="Row">
      <Text1 />
      <p className="[word-break:break-word] flex-[1_0_0] font-['Sora:Bold',sans-serif] leading-[1.5] min-w-px not-italic relative text-[#191919] text-[14px] text-right">$30.000.000</p>
    </div>
  );
}
...
function Row2() {
  return (
    <div className="content-stretch flex gap-[4px] h-[21px] items-start relative shrink-0 w-[312px]" data-name="Row">
      ...
      <p className="flex-[1_0_0] font-['Sora:Bold',sans-serif] min-w-px relative text-[#191919] text-right">15/07/2026</p>
    </div>
  );
}
