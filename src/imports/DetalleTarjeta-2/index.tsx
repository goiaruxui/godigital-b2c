import svgPaths from "./svg-a0ve2n7w0d";
            ...
            <div className="overflow-clip relative shrink-0 size-[20px]" data-name="Style=Outlined">
              <div className="absolute inset-[16.67%_8.33%]" data-name="Vector">
                <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.6667 13.3333">
                  <path d={svgPaths.p17159000} fill="var(--fill-0, #DF4730)" id="Vector" />
                </svg>
              </div>
            </div>
            <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#df4730] text-[14px] text-center whitespace-nowrap">Ver datos</p>
          </div>
        </div>
      </div>
      <div className="flex-[1_0_0] min-w-px relative rounded-[4px] self-stretch" data-name="button">
            ...
            <div className="overflow-clip relative shrink-0 size-[20px]" data-name="Style=Outlined">
              <div className="absolute inset-[8.33%]" data-name="Vector">
                <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.6667 16.6667">
                  <path d={svgPaths.p20f4c740} fill="var(--fill-0, #DF4730)" id="Vector" />
                </svg>
              </div>
            </div>
            <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#df4730] text-[14px] text-center whitespace-nowrap">Pausar</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Icon">
      ...
      <div className="col-1 ml-[6px] mt-[6px] overflow-clip relative row-1 size-[20px]" data-name="Style=Outlined">
        <div className="absolute inset-[12.5%_18.17%_12.5%_20.83%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.2 15">
            <path d={svgPaths.p2f2cf100} fill="var(--fill-0, #535D66)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Label() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[34px]" data-name="Label">
      <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] min-w-full not-italic relative shrink-0 text-[#191919] text-[12px] w-[min-content]">Agregar a Apple Wallet</p>
    </div>
  );
}
      ...
      <div className="col-1 ml-[6px] mt-[6px] overflow-clip relative row-1 size-[20px]" data-name="Style=Outlined">
        <div className="absolute bottom-1/4 left-[4.17%] right-[4.17%] top-1/4" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18.3333 10">
            <path d={svgPaths.p340a3c00} fill="var(--fill-0, #535D66)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Label1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[34px]" data-name="Label">
      <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] min-w-full not-italic relative shrink-0 text-[#191919] text-[12px] w-[min-content]">Cambiar PIN</p>
    </div>
  );
}
...
function Label2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[34px]" data-name="Label">
      <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] min-w-full not-italic relative shrink-0 text-[#191919] text-[12px] w-[min-content]">Límites</p>
    </div>
  );
}
...
function Bezel() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[157px] left-[calc(50%+1.81px)] overflow-clip rounded-[8px] top-[calc(50%-1.37px)] w-[155px]" data-name="Bezel">
      <div aria-hidden className="absolute inset-0 pointer-events-none rounded-[8px]">
        <div className="absolute bg-[rgba(166,166,166,0.7)] inset-0 rounded-[8px]" />
        <div className="absolute backdrop-blur-[67.957px] bg-[#333] inset-0 mix-blend-color-dodge rounded-[8px]" />
      </div>
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['SF_Pro:Regular',sans-serif] font-normal leading-[22px] left-[calc(50%-0.5px)] text-[#191919] text-[17px] text-center top-[calc(50%+37.5px)] tracking-[-0.4px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        Face ID
      </p>
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['SF_Pro:Light',sans-serif] font-[274.31500244140625] leading-[normal] left-[calc(50%+0.5px)] text-[72px] text-center text-white top-[calc(50%-60.5px)] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>{`\u{1003BD}`}</p>
    </div>
  );
}
...
export default function DetalleTarjeta() {
  return (
    <div className="relative size-full" data-name="DetalleTarjeta">
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[rgba(0,0,0,0.2)] h-[800px] left-1/2 top-1/2 w-[360px]" data-name="Face ID">
        <Bezel />
      </div>
    </div>
  );
