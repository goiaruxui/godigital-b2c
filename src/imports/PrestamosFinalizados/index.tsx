import svgPaths from "./svg-b1h1pt3enz";
    ...
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Typography">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[8px] py-[11px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Sora:Regular',sans-serif] leading-[1.5] min-w-px not-italic relative text-[#535d66] text-[14px] text-center">Vigentes</p>
        </div>
      </div>
    </div>
  );
...
function Typography1() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Typography">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[8px] py-[11px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Sora:Bold',sans-serif] leading-[1.5] min-w-px not-italic relative text-[#df4730] text-[14px] text-center">Finalizados</p>
        </div>
      </div>
    </div>
  );
...
function Tabs() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Tabs">
      ...
      <a className="content-stretch cursor-pointer flex flex-[1_0_0] flex-col h-[40px] items-center justify-center min-w-px relative" data-name="TabItem">
        <Typography />
      </a>
...
function Text() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative" data-name="text">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Sora:Bold',sans-serif] leading-[1.5] min-w-px not-italic relative text-[#191919] text-[16px]">$ 20.000.000</p>
      <div className="bg-[#f4fff8] content-stretch flex gap-[2px] items-center px-[6px] relative rounded-[100px] shrink-0" data-name="Chip">
        <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#289b4f] text-[12px] text-right whitespace-nowrap">Finalizado</p>
      </div>
    </div>
  );
}
...
function Div() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col items-start leading-[1.5] min-w-px not-italic relative" data-name="div">
      <p className="font-['Sora:Regular',sans-serif] relative shrink-0 text-[#535d66] text-[12px] w-full">{`Finalizado el `}</p>
      <p className="font-['Sora:Bold',sans-serif] relative shrink-0 text-[#191919] text-[14px] w-full">30/12/2023</p>
    </div>
  );
}
...
export default function PrestamosFinalizados() {
  return (
    <div className="bg-white relative size-full" data-name="Préstamos-Finalizados">
