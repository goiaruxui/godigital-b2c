import svgPaths from "./svg-cdwhhtrnuw";
...
function Body() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] inset-[44px_0_0_0] items-center justify-center px-[16px] py-[40px]" data-name="body">
      ...
      <div className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[0] min-w-full not-italic relative shrink-0 text-[#191919] text-[16px] text-center w-[min-content]">
        ...
        <p className="leading-[1.5]">verificando tu identidad...</p>
      </div>
    </div>
  );
}
