import svgPaths from "./svg-hznsvny2l6";
...
function Money() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="money">
      ...
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#bac2c7] text-[0px] text-center whitespace-nowrap">
        <span className="leading-[1.5] text-[36px]">0</span>
      ...
      <div className="h-0 relative shrink-0 w-full" data-name="divider">
        <div className="absolute inset-[-1px_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 197 2">
            <path d="M0 1H197" id="divider" stroke="var(--stroke-0, #005794)" strokeWidth="2" />
          </svg>
        </div>
      </div>
      ...
      <div className="bg-[#edeff6] h-[45px] relative rounded-[4px] shrink-0 w-full" data-name="button">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex gap-[4px] items-center justify-center p-[12px] relative size-full">
            <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#bac2c7] text-[14px] text-center whitespace-nowrap">Simular adelanto</p>
          </div>
        </div>
      </div>
    </div>
...
export default function SimularPrestamo() {
  return (
    <div className="bg-white relative size-full" data-name="SimularPréstamo1">
      <a className="absolute backdrop-blur-[10px] bg-[rgba(204,206,211,0.76)] bottom-0 content-stretch cursor-pointer flex flex-col gap-[7px] h-[231px] items-start left-0 p-[6px] right-0" data-name="Component 1">
        <RowNumbers />
        <RowNumbers1 />
        <RowNumbers2 />
        <RowNumbers3 />
