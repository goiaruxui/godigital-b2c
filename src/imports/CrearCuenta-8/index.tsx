import svgPaths from "./svg-jw89g2kn60";
...
function Itemlist() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative rounded-[5px] shrink-0" data-name="itemlist">
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="check_circle_outline">
        <div className="absolute inset-[8.33%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.3333 13.3333">
            <path d={svgPaths.p2f12a180} fill="var(--fill-0, #289B4F)" id="Vector" />
          </svg>
        </div>
      </div>
      <div className="[word-break:break-word] flex flex-col font-['Sora:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#289b4f] text-[14px] whitespace-nowrap">
...
function Body() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] inset-[44px_0_0_0] items-start pb-[40px] pt-[16px] px-[16px]" data-name="body">
      <TopBar />
      <Content />
      <Buttons />
    </div>
