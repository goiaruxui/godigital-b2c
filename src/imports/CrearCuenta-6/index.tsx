import svgPaths from "./svg-6lwu9djrp1";
import { imgRectangle2 } from "./svg-rku57";
...
function Title1() {
  return (
    <div className="content-stretch flex gap-[2px] items-start relative shrink-0" data-name="Title">
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[12px] text-center whitespace-nowrap">País de residencia</p>
    </div>
  );
}
...
function Left() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-w-px relative" data-name="Left">
      ...
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[14px] text-center whitespace-nowrap">Argentina</p>
    </div>
  );
}
          ...
          <div className="overflow-clip relative shrink-0 size-[20px]" data-name="arrow-down-s-line">
            <div className="absolute inset-[34.26%_23.48%_33.33%_23.48%]" data-name="Vector">
              <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.6067 6.48167">
                <path d={svgPaths.p2de05080} fill="var(--fill-0, #191919)" id="Vector" />
              </svg>
            </div>
          </div>
        </div>
...
function Content() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start min-h-px relative w-full" data-name="content">
      <Title />
      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Country/Default">
        <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="country">
          <Title1 />
          <Field />
          <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[12px] text-center whitespace-nowrap">Debe ser igual que el de tu documento de identidad</p>
        </div>
      </div>
    </div>
  );
