import svgPaths from "./svg-pgbxworre0";
import imgQrImage from "./44ecfdebca30716a48b8b2c08f7ddd45c4f22a66.png";
...
function Header() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col items-start left-0 pb-[12px] px-[16px] right-0 top-[44px]" data-name="header">
      <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[328px]" data-name="topbar">
        <Back />
        <Title />
      </div>
    </div>
...
export default function PagoQrScan() {
  return (
    <div className="relative size-full" data-name="PagoQR-Scan2">
      <div className="absolute bg-white inset-0 overflow-clip" data-name="ScanQR">
        <div className="absolute inset-[-64px_-198.42px_-114px_-195.58px]" data-name="QR-Image">
          <img alt="" className="absolute inset-0 max-w-none object-bottom pointer-events-none size-full" src={imgQrImage} />
        </div>
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 360 800">
          <g id="body">
            <path d={svgPaths.p37482680} fill="var(--fill-0, black)" fillOpacity="0.5" id="Dark mask" />
          </g>
        </svg>
          ...
          <div className="relative shrink-0 w-full" data-name="HomeIndicator">
            <div className="flex flex-col items-center justify-center size-full">
              <div className="content-stretch flex flex-col items-center justify-center pb-[9px] pt-[4px] px-[120px] relative size-full">
                <div className="bg-[#f7f8fe] h-[5px] relative rounded-[5px] shrink-0 w-[134px]" data-name="Indicator" />
              </div>
            </div>
          </div>
        </div>
