import svgPaths from "./svg-lz3rucsasq";
import { imgRectangle2 } from "./svg-z69ul";

function Title() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[328px]" data-name="Title">
      <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[14px] whitespace-nowrap">Tus monedas</p>
...
function DateAndTime() {
  return (
    <div className="content-stretch flex gap-[4px] items-start relative shrink-0" data-name="Date and time">
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#78838d] text-[12px] whitespace-nowrap">ARS</p>
    </div>
  );
}
...
function Name() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Name">
      <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[12px] whitespace-nowrap">Pesos</p>
      <DateAndTime />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Left">
      <div className="bg-[#f7f8fe] content-stretch flex items-center justify-center overflow-clip p-[6px] relative rounded-[64px] shrink-0" data-name="IconItem">
        <div className="relative rounded-[100px] shrink-0 size-[20px]" data-name="flags / AR">
...
function Amount1() {
  return (
    <div className="content-stretch flex items-start justify-end relative shrink-0" data-name="Amount">
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[12px] text-right whitespace-nowrap">0,00 ARS</p>
    </div>
  );
}
...
function DateAndTime1() {
  return (
    <div className="content-stretch flex gap-[4px] items-start relative shrink-0" data-name="Date and time">
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#78838d] text-[12px] whitespace-nowrap">BTC</p>
    </div>
  );
}
...
function Name1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Name">
      <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[12px] whitespace-nowrap">Bitcoin</p>
      <DateAndTime1 />
    </div>
  );
}
...
function Left1() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Left">
      <div className="bg-[#f7f8fe] content-stretch flex items-center justify-center overflow-clip p-[6px] relative rounded-[64px] shrink-0" data-name="IconItem">
        <div className="overflow-clip relative shrink-0 size-[20px]" data-name="Coin=BTC">
          <div className="absolute inset-[8.33%_19.18%_8.33%_23.13%]" data-name="vector">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.5385 16.6667">
              <path clipRule="evenodd" d={svgPaths.p55cfe00} fill="var(--fill-0, #78838D)" fillRule="evenodd" id="vector" />
            </svg>
          </div>
        </div>
      </div>
...
function Amount4() {
  return (
    <div className="content-stretch flex items-center justify-end relative shrink-0 w-full" data-name="Amount">
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#bac2c7] text-[12px] text-right whitespace-nowrap">= 0,00000000 BTC</p>
    </div>
  );
}
...
function DateAndTime2() {
  return (
    <div className="content-stretch flex gap-[4px] items-start relative shrink-0" data-name="Date and time">
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#78838d] text-[12px] whitespace-nowrap">ETH</p>
    </div>
  );
}
...
function Name2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Name">
      <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[12px] whitespace-nowrap">Ethereum</p>
      <DateAndTime2 />
    </div>
  );
}
...
function Left2() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Left">
      <div className="bg-[#f7f8fe] content-stretch flex items-center justify-center overflow-clip p-[6px] relative rounded-[64px] shrink-0" data-name="IconItem">
        <div className="overflow-clip relative shrink-0 size-[20px]" data-name="Coin=ETH">
          <div className="absolute bottom-[8.33%] left-1/4 right-[25.88%] top-[8.33%]" data-name="vector">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.82344 16.6667">
              <g id="vector">
                <path d={svgPaths.p1d389e00} fill="var(--fill-0, #78838D)" />
                <path d={svgPaths.p28c7ed00} fill="var(--fill-0, #78838D)" />
              </g>
            </svg>
          </div>
        </div>
...
function Amount7() {
  return (
    <div className="content-stretch flex items-center justify-end relative shrink-0 w-full" data-name="Amount">
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#bac2c7] text-[12px] text-right whitespace-nowrap">= 0,00000000 ETH</p>
    </div>
  );
}
...
function Coins1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Coins">
...
function Coins() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Coins">
      <Title />
      <Coins1 />
    </div>
  );
  ...
  return (
    <div className="h-[67px] relative shrink-0 w-[63px]" data-name="undraw_void_-3-ggu 1">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 63 67">
        <g clipPath="url(#clip0_1_11091)" id="undraw_void_-3-ggu 1">
          ...
          <path d={svgPaths.p5f2300} fill="var(--fill-0, #EDEFF7)" id="Vector_6" />
          ...
          <path d={svgPaths.p297b8580} fill="var(--fill-0, #EDEFF7)" id="Vector_13" />
          <path d={svgPaths.p512e100} fill="var(--fill-0, #FFB8B8)" id="Vector_14" />
          <path d={svgPaths.p14bcfa00} fill="var(--fill-0, #EDEFF7)" id="Vector_15" />
...
function EmptyState() {
  return (
    <div className="content-stretch flex flex-col gap-[6px] items-center justify-center relative shrink-0" data-name="EmptyState">
      <UndrawVoid3Ggu />
      <div className="[word-break:break-word] flex flex-col font-['Sora:Regular',sans-serif] h-[41px] justify-center leading-[0] not-italic relative shrink-0 text-[#78838d] text-[12px] text-center w-[170px]">
        <p className="leading-[1.5]">Aún no hay movimientos para mostrar aquí.</p>
      </div>
    </div>
  );
}
...
function Top() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="top">
      <Greeting />
      <div className="overflow-clip relative shrink-0 size-[28px]" data-name="notifications_none">
...
function Div() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-w-px relative" data-name="Div">
      ...
      <div className="bg-[#f4fff8] content-stretch flex gap-[2px] items-center px-[6px] relative rounded-[100px] shrink-0" data-name="Chip">
        <div className="overflow-clip relative shrink-0 size-[12px]" data-name="arrow_circle_up">
          <div className="absolute inset-[8.33%]" data-name="Vector">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 10">
              <path d={svgPaths.p29059000} fill="var(--fill-0, #289B4F)" id="Vector" />
            </svg>
          </div>
        </div>
        <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#289b4f] text-[12px] text-right whitespace-nowrap">34,6%</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="flex flex-row items-center self-stretch">
      <div className="[word-break:break-word] content-stretch flex h-full items-start leading-[1.5] not-italic relative shrink-0 text-center text-white whitespace-nowrap" data-name="number">
        <p className="font-['Sora:Bold',sans-serif] relative shrink-0 text-[36px]">0</p>
...
function Left3() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Left">
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">ARS</p>
    </div>
  );
}
...
function Field() {
  return (
    <div className="content-stretch flex gap-[8px] h-[37px] items-center p-[12px] relative rounded-[4px] shrink-0" data-name="Field">
      <Left3 />
      <div className="overflow-clip relative shrink-0 size-[20px]" data-name="arrow-down-s-line">
        <div className="absolute inset-[34.26%_23.48%_33.33%_23.48%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.6067 6.48167">
            <path d={svgPaths.p2de05080} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Price() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full" data-name="price">
      <Number />
      <Input />
    </div>
  );
...
function Exchange() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center relative shrink-0" data-name="Exchange">
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="currency_exchange">
        <div className="absolute inset-[4.17%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.6667 14.6667">
            <path d={svgPaths.pc03a000} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[12px] text-center text-white whitespace-nowrap">Intercambiar</p>
    </div>
  );
}
...
export default function Home() {
  return (
    <div className="relative size-full" data-name="Home">
      <div className="absolute bg-white h-[800px] left-[0.42px] overflow-clip top-0 w-[360px]" data-name="Home">
        <Body />
        <Header />
