import svgPaths from "./svg-pcmzhr1rww";
...
function Left1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-w-px relative" data-name="Left">
      <p className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#bac2c7] text-[14px] text-center whitespace-nowrap">Ingresa tu contraseña</p>
    </div>
  );
}
      ...
      <div className="bg-[#edeff6] h-[45px] relative rounded-[4px] shrink-0 w-full" data-name="button">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex gap-[4px] items-center justify-center p-[12px] relative size-full">
            <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#bac2c7] text-[14px] text-center whitespace-nowrap">Iniciar sesión</p>
          </div>
        </div>
      </div>
...
function Body() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] inset-[44px_0_238px_0] items-start pb-[40px]" data-name="body">
      <Header />
      <Content />
    </div>
  );
...
export default function Login() {
  return (
    <div className="bg-white relative size-full" data-name="Login">
      <a className="absolute backdrop-blur-[10px] bg-[rgba(204,206,211,0.76)] bottom-0 content-stretch cursor-pointer flex flex-col gap-[12px] h-[238px] items-start left-0 px-[3px] py-[8px] right-0" data-name="Component 1">
        <RowAlphabetic />
        <RowAlphabetic1 />
