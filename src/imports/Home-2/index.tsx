import svgPaths from "./svg-kvtmty2eyu";
...
function Title1() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="Title">
      <Div />
      <button className="bg-[#841a0a] content-stretch cursor-pointer flex gap-[4px] items-center justify-center px-[8px] py-[3px] relative rounded-[4px] shrink-0" data-name="button">
