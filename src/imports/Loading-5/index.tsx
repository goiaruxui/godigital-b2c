import svgPaths from "./svg-8t4nq9cmx9";

function Loading1() {
  return (
    <div className="absolute contents inset-0" data-name="loading">
      <div className="absolute bg-[#005794] bottom-3/4 left-[45.83%] right-[45.83%] rounded-[10px] top-0" />
      <div className="absolute bottom-[45.83%] flex items-center justify-center left-0 right-3/4 top-[45.83%]" style={{ containerType: "size" }}>
        <div className="-rotate-90 flex-none h-[100cqw] w-[100cqh]">
          <div className="bg-[#005794] opacity-70 relative rounded-[10px] size-full" />
        </div>
      </div>
      <div className="absolute bottom-0 flex items-center justify-center left-[45.83%] right-[45.83%] top-3/4" style={{ containerType: "size" }}>
        <div className="flex-none h-[100cqh] rotate-180 w-[100cqw]">
          <div className="bg-[#005794] opacity-50 relative rounded-[10px] size-full" />
        </div>
      </div>
      <div className="absolute bottom-[45.83%] flex items-center justify-center left-3/4 right-0 top-[45.83%]" style={{ containerType: "size" }}>
        <div className="flex-none h-[100cqw] rotate-90 w-[100cqh]">
          <div className="bg-[#005794] opacity-30 relative rounded-[10px] size-full" />
        </div>
      </div>
      <div className="absolute flex inset-[11.7%_64.73%_64.73%_11.7%] items-center justify-center" style={{ containerType: "size" }}>
        <div className="-rotate-45 flex-none h-[hypot(75cqw,75cqh)] w-[hypot(25cqw,-25cqh)]">
          <div className="bg-[#005794] opacity-80 relative rounded-[10px] size-full" />
        </div>
      </div>
      <div className="absolute flex inset-[64.73%_64.73%_11.7%_11.7%] items-center justify-center" style={{ containerType: "size" }}>
        <div className="-rotate-135 flex-none h-[hypot(75cqw,-75cqh)] w-[hypot(-25cqw,-25cqh)]">
          <div className="bg-[#005794] opacity-60 relative rounded-[10px] size-full" />
        </div>
      </div>
      <div className="absolute flex inset-[64.73%_11.7%_11.7%_64.73%] items-center justify-center" style={{ containerType: "size" }}>
        <div className="flex-none h-[hypot(-75cqw,-75cqh)] rotate-135 w-[hypot(-25cqw,25cqh)]">
          <div className="bg-[#005794] opacity-40 relative rounded-[10px] size-full" />
        </div>
      </div>
      <div className="absolute flex inset-[11.7%_11.7%_64.73%_64.73%] items-center justify-center" style={{ containerType: "size" }}>
        <div className="flex-none h-[hypot(-75cqw,75cqh)] rotate-45 w-[hypot(25cqw,25cqh)]">
          <div className="bg-[#005794] opacity-10 relative rounded-[10px] size-full" />
        </div>
      </div>
    </div>
  );
...
function Body() {
  return (
    <div className="absolute bottom-0 content-stretch flex flex-col gap-[24px] h-[756px] items-center justify-center left-0 px-[16px] py-[40px] right-0" data-name="body">
      <div className="relative shrink-0 size-[48px]" data-name="Loading">
        <Loading1 />
      </div>
      <div className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[0] min-w-full not-italic relative shrink-0 text-[#191919] text-[16px] text-center w-[min-content]">
        <p className="leading-[1.5] mb-0">Aguarda, estamos</p>
        <p className="leading-[1.5]">solicitando tu préstamo...</p>
      </div>
    </div>
  );
}
...
export default function Loading() {
  return (
    <div className="bg-white relative size-full" data-name="loading">
      <Body />
