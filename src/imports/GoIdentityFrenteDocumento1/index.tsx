import svgPaths from "./svg-rfvxvk23dk";
...
function Text() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] h-[120px] items-center leading-[1.5] not-italic relative shrink-0 w-full" data-name="text">
      <p className="font-['Sora:Bold',sans-serif] relative shrink-0 text-[#191919] text-[18px] w-full">Toma la foto del frente de tu documento</p>
      <p className="font-['Sora:Regular',sans-serif] relative shrink-0 text-[#78838d] text-[14px] w-full">Centra el documento dentro del área segura para que podamos validar la información.</p>
    </div>
  );
}
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%-126.74px)] size-[34.528px] top-[calc(50%-78.24px)]">
        <div className="absolute inset-[-5.79%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 38.5285 38.5285">
            <path d={svgPaths.p23c06498} id="Rectangle 9318" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeWidth="4" />
          </svg>
        </div>
      </div>
          ...
          <div className="h-[34.528px] relative w-[33.824px]">
            <div className="absolute inset-[-5.79%_-5.91%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 37.8238 38.5285">
                <path d={svgPaths.p28e0f180} id="Rectangle 9320" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeWidth="4" />
              </svg>
            </div>
          </div>
        </div>
...
function Body() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[714px] items-start left-0 pb-[40px] pt-[16px] px-[16px] top-[86px] w-[360px]" data-name="body">
      <Bullets />
      <Buttons />
    </div>
  );
...
export default function GoIdentityFrenteDocumento() {
  return (
    <div className="bg-white relative size-full" data-name="GOIdentity-FrenteDocumento-1">
