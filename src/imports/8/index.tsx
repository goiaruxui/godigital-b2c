import svgPaths from "./svg-6dbcaoqwnk";
import imgCapturaDePantalla20231024ALaS11033 from "./9dd12b3c49d8ce45ebe9b269a9d61d5d726a1afa.png";
import imgCapturaDePantalla20231024ALaS11034 from "./17b57e6964e7c9e9ca9853f06320d23ba1f3b319.png";
...
function Frame2() {
  return (
    <div className="bg-[#f7f8fe] content-stretch flex gap-[8px] items-center justify-center px-[16px] py-[8px] relative rounded-[8px] shrink-0">
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="arrow_circle_left">
        <div className="absolute inset-[8.33%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
            <path d={svgPaths.p2561bd80} fill="var(--fill-0, #191919)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[18px] text-center whitespace-nowrap">Mira hacia la izquierda</p>
    </div>
  );
}
...
function Camera() {
  return (
    <div className="h-[343px] overflow-clip relative rounded-[8px] shrink-0 w-full" data-name="camera">
      <div className="absolute inset-[-0.15%_-52.24%_-0.73%_-43.59%] rounded-[8px]" data-name="Captura de pantalla 2023-10-24 a la(s) 11.03 3">
        <div aria-hidden className="absolute inset-0 pointer-events-none rounded-[8px]">
          <div className="absolute inset-0 overflow-hidden rounded-[8px]">
            <img alt="" className="absolute h-[106.12%] left-[-1.45%] max-w-none top-[-3.06%] w-[313.01%]" src={imgCapturaDePantalla20231024ALaS11033} />
          </div>
          <div className="absolute inset-0 overflow-hidden rounded-[8px]">
            <img alt="" className="absolute h-[169.76%] left-[-5.35%] max-w-none top-[-8.44%] w-[116.05%]" src={imgCapturaDePantalla20231024ALaS11034} />
          </div>
        </div>
      </div>
