import svgPaths from "./svg-533kpew10l";
...
function TopSection() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center relative shrink-0 w-full" data-name="Top section">
      ...
      <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] min-w-full not-italic relative shrink-0 text-[#191919] text-[16px] text-center w-[min-content]">Estás por pausar tu tarjeta</p>
      <div className="[word-break:break-word] font-['Sora:Regular',sans-serif] leading-[0] min-w-full not-italic relative shrink-0 text-[#535d66] text-[14px] text-center w-[min-content]">
        <p className="leading-[1.5] mb-0">Ten en cuenta que no podrás utilizarla para hacer pagos o compras.</p>
      ...
      <div className="bg-[#df4730] h-[45px] relative rounded-[4px] shrink-0 w-full" data-name="button">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex gap-[4px] items-center justify-center p-[12px] relative size-full">
            <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Si, pausar tarjeta</p>
          </div>
        </div>
      </div>
      <button className="cursor-pointer h-[45px] relative rounded-[4px] shrink-0 w-full" data-name="button">
