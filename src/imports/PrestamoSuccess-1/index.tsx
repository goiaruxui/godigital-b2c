import svgPaths from "./svg-ps21m9w64e";
...
function Text() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[4px] items-center leading-[1.5] not-italic relative shrink-0 text-center w-full" data-name="Text">
      <p className="font-['Sora:Bold',sans-serif] relative shrink-0 text-[#191919] text-[16px] w-full">¡Has solicitado tu adelanto!</p>
      <p className="font-['Sora:Regular',sans-serif] relative shrink-0 text-[#535d66] text-[14px] w-full">Ya tienes disponible el dinero en tu billetera.</p>
    </div>
  );
}
  ...
  return (
    <div className="relative rounded-[8px] shrink-0 w-full" data-name="itemlist">
      ...
      <div className="[word-break:break-word] content-stretch flex flex-col items-start leading-[1.5] not-italic px-[16px] py-[12px] relative size-full text-[12px]">
        ...
        <p className="font-['Sora:Bold',sans-serif] min-w-full relative shrink-0 text-[#535d66] w-[min-content]">$9.584.380</p>
      </div>
    </div>
  );
}
          ...
          <div className="overflow-clip relative shrink-0 size-[24px]" data-name="content_copy">
            <div className="absolute inset-[4.17%_10.42%]" data-name="Vector">
              <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19 22">
                <path d={svgPaths.p10e56200} fill="var(--fill-0, #005794)" id="Vector" />
              </svg>
            </div>
          </div>
        </div>
...
function List() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center justify-center relative shrink-0 w-full" data-name="list">
      <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#191919] text-[14px] w-full">Detalle del adelanto</p>
      <Itemlist />
      <Itemlist1 />
            ...
            <div className="overflow-clip relative shrink-0 size-[20px]" data-name="Style=Outlined">
              <div className="absolute inset-[14.58%_18.75%]" data-name="Vector">
                <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.5 14.1667">
                  <path d={svgPaths.p1c3d8c00} fill="var(--fill-0, #005794)" id="Vector" />
                </svg>
              </div>
            </div>
            <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#005794] text-[14px] text-center whitespace-nowrap">Reportar un problema</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start justify-end relative shrink-0 w-full" data-name="buttons">
      <div className="h-[45px] relative rounded-[4px] shrink-0 w-full" data-name="button">
        <div aria-hidden className="absolute border border-[#005794] border-solid inset-0 pointer-events-none rounded-[4px]" />
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex gap-[4px] items-center justify-center p-[12px] relative size-full">
            <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#005794] text-[14px] text-center whitespace-nowrap">Ver detalle</p>
          </div>
        </div>
      </div>
      <div className="bg-[#005794] h-[45px] relative rounded-[4px] shrink-0 w-full" data-name="button">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex gap-[4px] items-center justify-center p-[12px] relative size-full">
            <p className="[word-break:break-word] font-['Sora:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Volver a adelantos</p>
          </div>
        </div>
      </div>
    </div>
...
export default function PrestamoSuccess() {
  return (
    <div className="relative size-full" data-name="Préstamo-Success">
